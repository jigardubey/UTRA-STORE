          ...
          <>
            ...
            <div className="mt-4 pt-3 border-t border-gray-100 flex flex-col gap-2">
              <button
                type="button"
                onClick={handleGuest}
                className="w-full py-2.5 px-4 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-xs rounded-xl flex items-center justify-center gap-2 transition-colors"
              >
              ...
              <button
                ...
                className="text-[11px] text-gray-400 hover:text-indigo-600 font-semibold inline-flex items-center justify-center gap-1 transition-colors py-1"
              >
